...
package com.cpigeon.app.view.video.record.video;
...
import com.cpigeon.app.view.video.gpufilter.basefilter.GPUImageFilter;
import com.cpigeon.app.view.video.gpufilter.basefilter.MagicCameraInputFilter;
import com.cpigeon.app.view.video.record.gles.EglCore;
...
//    private MagicFilterType type = MagicFilterType.NONE;
    private AFilter mShowFilter=new NoFilter(MyApp.getInstance().getBaseContext().getResources());
