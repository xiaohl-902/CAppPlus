package com.cpigeon.app.view.video.mediacodec;
/*
...
import com.cpigeon.app.view.video.drawer.VideoDrawer;
import com.cpigeon.app.view.video.gpufilter.basefilter.GPUImageFilter;
import com.cpigeon.app.view.video.media.VideoInfo;
...
//        mTextureRender.surfaceCreated();
        ...
        mDrawer = new VideoDrawer(MyApp.getInstance().getBaseContext(),MyApp.getInstance().getBaseContext().getResources());
