...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = MyApp.getInstance().getBaseContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = MyApp.getInstance().getBaseContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
