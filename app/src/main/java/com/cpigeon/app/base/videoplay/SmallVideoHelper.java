...
//                    Log.d("myxiaohl", "onQuitFullscreen: 进入全屏");
                    ...
                    if( MapLiveActivity.viewpagertab != null){
                        MapLiveActivity.viewpagertab.setVisibility(View.GONE);
                    }

                    if(MapLiveActivity.viewPager != null){
                        MapLiveActivity.viewPager.setScanScroll(false);
                    }

                    if(MainActivity.mBottomNavigationBar != null){
                        MainActivity.mBottomNavigationBar.setVisibility(View.GONE);
                    }
                    doFullBtnLogic();
                }
            });
