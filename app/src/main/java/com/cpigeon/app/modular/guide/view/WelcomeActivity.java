...
//    Button skip;
    ...
    public void initView(Bundle savedInstanceState) {
        ...
        for(int i = 0; i < 3; i++){
            ...
            mContentFragmentAdapter.appendData(welcomeFragment);
        }
        ...
        pager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if(position == 2){
                    setCircleVisibal(false);
                }else {
                    setCircleVisibal(true);
                }
            }
...
//                break;
        ...
        if (index < NUM_PAGES) {
            for (int i = 0; i < NUM_PAGES - 1; i++) {
                ...
                if (i == index) {
                    ...
                    circle.setColorFilter(getResources().getColor(R.color.welcome_gray));
                }
            }
        }
    }
    ...
    public void setCircleVisibal(boolean isVisible){
        circles.setVisibility(isVisible ? View.VISIBLE : View.GONE);
    }
}
