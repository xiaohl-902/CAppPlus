...
public class RaceDaoImpl extends UserFollowDaoImpl implements IRaceDao {
     ...
     */
    @Override
    public void showReprotData(int px, String matchType, String ssid, String foot, String name, boolean hascz, int pager, int pagesize, int czIndex, String sKey, final OnCompleteListener<List> onCompleteListener) {
        CallAPI.getReportData(px, mContext, matchType, ssid, "", "", hascz, pager, pagesize, czIndex, sKey, new CallAPI.Callback<List>() {
            @Override
