 ...
 */
public class SelectFlyAdapter extends BaseAdapter<ContactModel.MembersEntity, SelectFlyAdapter.ContactViewHolders>
    ...
    public SelectFlyAdapter(Context ct, List<ContactModel.MembersEntity> mLists) {
        this.mLists = mLists;
        mContext = ct;
        this.addAll(mLists);
    }
            ...
            public void onClick(View v) {
                try {
                    if (!mLists.get(position).getLo().isEmpty() && mLists.get(position).getLa() != null) {
                        ...
                        ((Activity) mContext).setResult(0x0034, intent);
