...
public class UserInfoActivity extends BaseActivity<UserInfoPresenter> implements IUserInfoView {
    ...
    private void openCamera() {
        ...
        ChooseImageManager.openCamera(this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == PictureMimeType.ofImage()){
            ...
            mUserHeadImageLocalPath = selectList.get(0).getCutPath();
            BitmapFactory.Options options = new BitmapFactory.Options();
            options.inSampleSize = 2;
            Bitmap bm = BitmapFactory.decodeFile(mUserHeadImageLocalPath, options);
